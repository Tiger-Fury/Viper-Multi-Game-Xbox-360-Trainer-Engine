...
UINT32 g_titleID = 0x454108F7;


DWORD MYPtr1;
DWORD addr_ammo1 = 0x827F9F90;
DWORD Ammo_On = 0x48000010;
DWORD Ammo_On9 = 0x00000008;
DWORD Ammo_off = 0x40980010;
...
static void RunTrainerMenu(void)
...
VOID ButPress( MESSAGEBOX_RESULT g_mb_result )
{
	...
	if( g_mb_result.rgwPasscode[0] == RIGHT_TRIGGER && g_mb_result.rgwPasscode[1] == RIGHT_TRIGGER && g_mb_result.rgwPasscode[2] == RIGHT_TRIGGER && g_mb_result.rgwPasscode[3] == RIGHT_TRIGGER )
	{
		...
		if( InfHealth == TRUE )
		{
			...
			SetDWORD(0x82494DB4, 0x7D2707B4);
			InfHealth = FALSE;
			Vibr01();
			...
			SetDWORD(0x82494DB4, 0x907F0348);
			InfHealth = TRUE;
			Vibr01();
...
VOID SearchAddr()
{
	hNotify(L"Medal Of Honor");
	Sleep(25);
	SetAddr = true;
	ShowTrainerMain = RunTrainerMenu;
}