...
float WDXValue = 100.0;


VOID __declspec(naked) WDCheckHealth(VOID)
{ 
	...
	if(   *(DWORD*)(MYPtr1+0x0c) == 0x0117CED9 &&  InfHealth == TRUE ) {
		__asm { 


			stfs WDXValue,10h(r3)
...
VOID WDSetHooks()
{
	...
	Caveme(0x833A63A4,WDCheckHealth,15);
	HooksSet = true;
}


VOID Trainer555308b7()
{
	Prompt = XShowMessageBoxUI(0, L"https://www.t3fury.co.uk", L"Watch Dogs + 7\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
	if( HooksSet == false )
	{
		WDSetHooks();
...
VOID Press555308b7( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_555308b7()
{
	hNotify(L"Watch Dogs");
	Sleep(25);

	Run_Input = Press555308b7;
	Run_Trainer = Trainer555308b7;
