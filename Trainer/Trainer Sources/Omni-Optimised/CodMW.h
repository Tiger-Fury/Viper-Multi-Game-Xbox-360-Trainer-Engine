...
DWORD CODMWAmmobuf[] = {0x7D7E5850, 0x7D6AE92E};


VOID Trainer415607E6()
{
	Prompt = XShowMessageBoxUI(0, L"https://www.t3fury.co.uk", L"Cod MW TU4\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
}

VOID Press415607E6( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_415607E6()
{
	hNotify(L"Call of Duty MW TU4");
	Sleep(25);
	addr_ammo = GetAddr(0x82000000, 0x83000000, CODMWAmmobuf, 2, 1)+ 0x04;
	Run_Input = Press415607E6;
	Run_Trainer = Trainer415607E6;
