...
VOID Trainer4E4D07D8()
{
	Prompt = XShowMessageBoxUI(0, L"https://www.t3fury.co.uk", L"Afro Samurai + 1\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
}


VOID Press4E4D07D8( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_4E4D07D8()
{
	...
	Run_Input = Press4E4D07D8;
	Run_Trainer = Trainer4E4D07D8;
