...
DWORD CODMW3Ammobuf[] = {0x7D3D5050, 0x7D2B192E};


VOID Trainer415608CB()
{
	Prompt = XShowMessageBoxUI(0, L"https://www.t3fury.co.uk", L"Cod MW3 TU23\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
}

VOID Press415608CB( MESSAGEBOX_RESULT g_mb_result )
{
	...
	if( g_mb_result.rgwPasscode[0] == LEFT_BUMPER && g_mb_result.rgwPasscode[1] == LEFT_BUMPER && g_mb_result.rgwPasscode[2] == LEFT_BUMPER && g_mb_result.rgwPasscode[3] == LEFT_BUMPER )
	{
		...
		if( Max_XP == TRUE )
		{
			...
			SetDWORD(0x8370CD38,0x00f43521);
			Max_XP = TRUE;
			Vibr01();
...
VOID Boot_415608CB()
{
	hNotify(L"Call of Duty MW3 TU23");
	Sleep(25);
	addr_ammo = GetAddr(0x82000000, 0x83000000, CODMW3Ammobuf, 2, 1)+ 0x04;

	Run_Input = Press415608CB;
	Run_Trainer = Trainer415608CB;
