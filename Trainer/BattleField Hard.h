...
DWORD BFHLbuf[] = {0xeda007f2, 0xc19c0014};
DWORD BFHLbufAmmo[] = {0x7D0A5850, 0x917F0070};
DWORD BFHLbufstam[] = {0xC003002C, 0xEDA1002A};
DWORD BFHLbufspec[] = {0xEDA1073A, 0xD1BF0020};

VOID __declspec(naked) BFHLCheckHealth(VOID)
{ 
...
VOID BFHSearch()
{
	if (Gamexex == 1)
	{
		addr = GetAddr(0x89000000, 0x8A000000, BFHLbuf, 2, 1)+ 0x04;
		addr_ammo = GetAddr(0x88000000, 0x89000000, BFHLbufAmmo, 2, 1)+ 0x04;
		addr_XP = GetAddr(0x88000000, 0x89000000, BFHLbufstam, 2, 1)+ 0x04;
		addr_Special = GetAddr(0x89000000, 0x8A000000, BFHLbufspec, 2, 1)+ 0x04;
...
VOID Trainer454109E0()
{
	Prompt = XShowMessageBoxUI(0, L"More at T3fury.co.uk", L"BattleField Hardline + 4\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
...
VOID Press454109E0( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_454109E0()
{
	...
	Sleep(25);
	Run_Input = Press454109E0;
	Run_Trainer = Trainer454109E0;
