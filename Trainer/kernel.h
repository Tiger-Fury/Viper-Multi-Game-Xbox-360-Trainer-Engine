...
#define PatchJump(addr, codevave) PatchInJump(addr, codevave, 11, 1)

#define PatchJump3(addr, codevave) PatchInJump(addr, codevave, 3, 1)
#define PatchJump4(addr, codevave) PatchInJump(addr, codevave, 4, 1)
#define PatchJump5(addr, codevave) PatchInJump(addr, codevave, 5, 1)
#define PatchJump6(addr, codevave) PatchInJump(addr, codevave, 6, 1)
#define PatchJump7(addr, codevave) PatchInJump(addr, codevave, 7, 1)
#define PatchJump8(addr, codevave) PatchInJump(addr, codevave, 8, 1)
#define PatchJump9(addr, codevave) PatchInJump(addr, codevave, 9, 1)
#define PatchJump10(addr, codevave) PatchInJump(addr, codevave, 10, 1)
#define PatchJump11(addr, codevave) PatchInJump(addr, codevave, 11, 1)
#define PatchJump12(addr, codevave) PatchInJump(addr, codevave, 12, 1)
#define PatchJump13(addr, codevave) PatchInJump(addr, codevave, 13, 1)
#define PatchJump14(addr, codevave) PatchInJump(addr, codevave, 14, 1)
#define PatchJump15(addr, codevave) PatchInJump(addr, codevave, 15, 1)
#define PatchJump16(addr, codevave) PatchInJump(addr, codevave, 16, 1)
#define PatchJump17(addr, codevave) PatchInJump(addr, codevave, 17, 1)
#define PatchJump18(addr, codevave) PatchInJump(addr, codevave, 18, 1)
#define PatchJump19(addr, codevave) PatchInJump(addr, codevave, 19, 1)
#define PatchJump20(addr, codevave) PatchInJump(addr, codevave, 20, 1)
#define PatchJump21(addr, codevave) PatchInJump(addr, codevave, 21, 1)
#define PatchJump22(addr, codevave) PatchInJump(addr, codevave, 22, 1)
#define PatchJump23(addr, codevave) PatchInJump(addr, codevave, 23, 1)
#define PatchJump24(addr, codevave) PatchInJump(addr, codevave, 24, 1)
#define PatchJump25(addr, codevave) PatchInJump(addr, codevave, 25, 1)
#define PatchJump26(addr, codevave) PatchInJump(addr, codevave, 26, 1)
#define PatchJump27(addr, codevave) PatchInJump(addr, codevave, 27, 1)
#define PatchJump28(addr, codevave) PatchInJump(addr, codevave, 28, 1)
#define PatchJump29(addr, codevave) PatchInJump(addr, codevave, 29, 1)
#define PatchJump30(addr, codevave) PatchInJump(addr, codevave, 30, 1)

#define PatchJumpu3(addr, codevave) PatchInJump(addr, codevave, 3, 0)
#define PatchJumpu4(addr, codevave) PatchInJump(addr, codevave, 4, 0)
#define PatchJumpu5(addr, codevave) PatchInJump(addr, codevave, 5, 0)
#define PatchJumpu6(addr, codevave) PatchInJump(addr, codevave, 6, 0)
#define PatchJumpu7(addr, codevave) PatchInJump(addr, codevave, 7, 0)
#define PatchJumpu8(addr, codevave) PatchInJump(addr, codevave, 8, 0)
#define PatchJumpu9(addr, codevave) PatchInJump(addr, codevave, 9, 0)
#define PatchJumpu10(addr, codevave) PatchInJump(addr, codevave, 10, 0)
#define PatchJumpu11(addr, codevave) PatchInJump(addr, codevave, 11, 0)
#define PatchJumpu12(addr, codevave) PatchInJump(addr, codevave, 12, 0)
#define PatchJumpu13(addr, codevave) PatchInJump(addr, codevave, 13, 0)
#define PatchJumpu14(addr, codevave) PatchInJump(addr, codevave, 14, 0)
#define PatchJumpu15(addr, codevave) PatchInJump(addr, codevave, 15, 0)
#define PatchJumpu16(addr, codevave) PatchInJump(addr, codevave, 16, 0)
#define PatchJumpu17(addr, codevave) PatchInJump(addr, codevave, 17, 0)
#define PatchJumpu18(addr, codevave) PatchInJump(addr, codevave, 18, 0)
#define PatchJumpu19(addr, codevave) PatchInJump(addr, codevave, 19, 0)
#define PatchJumpu20(addr, codevave) PatchInJump(addr, codevave, 20, 0)
#define PatchJumpu21(addr, codevave) PatchInJump(addr, codevave, 21, 0)
#define PatchJumpu22(addr, codevave) PatchInJump(addr, codevave, 22, 0)
#define PatchJumpu23(addr, codevave) PatchInJump(addr, codevave, 23, 0)
#define PatchJumpu24(addr, codevave) PatchInJump(addr, codevave, 24, 0)
#define PatchJumpu25(addr, codevave) PatchInJump(addr, codevave, 25, 0)
#define PatchJumpu26(addr, codevave) PatchInJump(addr, codevave, 26, 0)
#define PatchJumpu27(addr, codevave) PatchInJump(addr, codevave, 27, 0)
#define PatchJumpu28(addr, codevave) PatchInJump(addr, codevave, 28, 0)
#define PatchJumpu29(addr, codevave) PatchInJump(addr, codevave, 29, 0)
#define PatchJumpu30(addr, codevave) PatchInJump(addr, codevave, 30, 0)
