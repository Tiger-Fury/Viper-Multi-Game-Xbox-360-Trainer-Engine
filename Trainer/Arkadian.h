...
DWORD Arkadianbuf[] = {0x3D608210, 0xD01F0D98};//
DWORD ArkadianTimerbuf[] = {0x556B003E, 0x9143001C};//
DWORD Arkadianxpbuf[] = {0x7D6BF214, 0x814A0550};//
DWORD Arkadianammobuf[] = {0x914B0004, 0x4BFFF341};
DWORD Arkadianweabuf[] = {0x817F23C4, 0x939F3720};//
DWORD Arkadianabilbuf[] = {0x2F040000, 0x917F0038};//
//DWORD cashbuf[] = {0x39200061, 0x917F0070};//


VOID Trainer58410807()
{
	Prompt = XShowMessageBoxUI(0, L"More at T3fury.co.uk", L"Arkadian Warriors + 4\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
}


VOID Press58410807( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_58410807()
{
	...
	Run_Input = Press58410807;
	Run_Trainer = Trainer58410807;
	...
	Sleep(25);
	addr = GetAddr(0x82000000, 0x83000000, Arkadianbuf, 2, 1)+0x04;
	addr_XP = GetAddr(0x82000000, 0x83000000, Arkadianxpbuf, 2, 1);
	addr_ammo = GetAddr(0x82000000, 0x83000000, Arkadianammobuf, 2, 1)-0x04;
	addr_Special = GetAddr(0x82000000, 0x83000000, Arkadianweabuf, 2, 1)+0x04;
	SetAddr = true;
}