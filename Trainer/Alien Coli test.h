...
UINT32 g_titleID = 0x5841127A;


DWORD MYPtr1;
DWORD addr_ammo1 = 0x8236D9C4;
DWORD Ammo_On = 0x41700000;
DWORD Ammo_On9 = 0x00000008;
DWORD Ammo_off = 0x911E0000;
DWORD Dvalue = 0x000f423f;
float XValue = 999.0;
float ZValue = 0.0;
...
VOID SetHooks()
{
    Caveme(0x822AF3D8,CheckHealth,18);
    HooksSet = true;
}
