...
DWORD ConDOaddr_ammo1 = 0x82291A7C;
DWORD ConDOHVaddr;
DWORD ConDOHVbuf[] = {0xED8CF028, 0xD19F07C4};
DWORD ConDOGrenbuf[] = {0x917D00E4, 0x817D00E4};
DWORD ConDOammobuf[] = {0x917E0148, 0x817E00E4};



VOID __declspec(naked) ConDOCheckHealth(VOID)
{ 
...
VOID ConDOSetHooks()
{
    Caveme(HVaddr,ConDOCheckHealth,20);
    HooksSet = true;
}

VOID Trainer534307D3()
{
	Prompt = XShowMessageBoxUI(0, L"More at T3fury.co.uk", L"Conflict Denied Ops + 4\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
	if( HooksSet == false )
	{
		ConDOSetHooks();
	}
...
VOID Press534307D3( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_534307D3()
{
	hNotify(L"Conflict Denied Ops");
	HVaddr = GetAddr(0x82000000, 0x83000000, ConDOHVbuf, 2, 1)+0x04;
	addr_ammo = GetAddr(0x82000000, 0x83000000, ConDOammobuf, 2, 1)-0x04;
	addr_Gren = GetAddr(0x82000000, 0x83000000, ConDOGrenbuf, 2, 1)-0x04;
	Sleep(25);
	Run_Input = Press534307D3;
	Run_Trainer = Trainer534307D3;
