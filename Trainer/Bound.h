...
VOID __declspec(naked) bbfCheckHealth(VOID)
{ 
	__asm{
			lfs fr11,2500h(r10)
	...
	if( MYPtr1 == 0xEAE26E && OneHitKo == TRUE )
		{
			__asm
			{
...
VOID __declspec(naked) bbfCheckWeight(VOID)
{ 
...
VOID __declspec(naked) bbfCheckItem(VOID)
{ 
...
VOID __declspec(naked) bbfCheckXP(VOID)
{ 
...
VOID SetHooks()
{
    Caveme(0x8274FD2C,bbfCheckHealth,16);
	Caveme(0x827845A8,bbfCheckWeight,16);
	Caveme(0x82785B04,bbfCheckItem,16);
	Caveme(0x82750CBC,bbfCheckXP,16);
    HooksSet = true;
}

VOID Trainer464507DD()
{
	Prompt = XShowMessageBoxUI(0, L"https://www.t3fury.co.uk", L"Bound by Flame + 7\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
	if( HooksSet == false )
	{
		SetHooks();
	}
...
VOID Press464507DD( MESSAGEBOX_RESULT g_mb_result )
{
...
VOID Boot_464507DD()
{
	...
	Run_Input = Press464507DD;
	Run_Trainer = Trainer464507DD;
