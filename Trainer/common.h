...
void (*Run_Trainer)(void);
void (*Run_Input)( MESSAGEBOX_RESULT g_mb_result );
void (*Run_Statics)(void);
void (*Quicklaunch1)(void);
void (*Quicklaunch2)(void);
void (*Quicklaunch3)(void);
void (*Quicklaunch4)(void);
void (*Quicklaunch5)(void);
void (*Quicklaunch6)(void);
void (*Quicklaunch7)(void);
void (*Quicklaunch8)(void);

VOID NullQuicklaunch1(){

}
VOID NullQuicklaunch2(){

}
VOID NullQuicklaunch3(){

}
VOID NullQuicklaunch4(){

}
VOID NullQuicklaunch5(){

}
VOID NullQuicklaunch6(){

}
VOID NullQuicklaunch7(){

}
VOID NullQuicklaunch8(){
...
// DWORD XGetGameMediaID()
// {
// 	UINT8 b[4];
// 	GetMem(0x781E0FC0, MediaID, 4);
// 	return btodw(b);
// }
// 
// WCHAR szXPG[256];
// VOID Badmediaid()
// {
// 	//DWORD _activeMediaID = XGetGameMediaID();
// 	//DWORD _activeTitleID = _game;
// 	Prompt = XShowMessageBoxUI(0, L"TeamXPG ", L"Incompatible Game\r\nCurrent MEDIA ID Is Incorrect\r\nPlease Launch Correct Game to Continue\r\nFor more info go to XPGamesaves.com", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_NOICON, &g_mb_result, &g_xol);									
// 	//swprintf_s(szXPG, 256, L"Current Media ID: " L"%08X\n"
// 	//L"Current Media ID: " L"%08X\n"
// 	//,_activeMediaID);
// 	//XShowMessageBoxUI(0,L"TeamXPG",szXPG,1,btnOk,0,XMB_NOICON,&g_mb_result,&g_xol);
// }
